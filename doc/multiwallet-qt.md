...
In order to support loading of multiple wallets in rupaya-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rupaya.cpp.
...
Changes to rupaya.cpp
----------------------
rupaya.cpp is the entry point into rupaya-qt, and as such, will require some minor modifications to provide hooks for
